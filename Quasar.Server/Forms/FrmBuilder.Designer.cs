...
namespace Quasar.Server.Forms
{
    partial class FrmBuilder
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tooltip.SetToolTip(this.picUAC2, "在系统中安装客户端需要管理员权限.");
            // 
            // picUAC1
            // 
            ...
            this.tooltip.SetToolTip(this.picUAC1, "在 Program Files 中安装客户端需要管理员权限.");
            // 
            // rbSystem
            // 
            ...
            this.tooltip.SetToolTip(this.rbSystem, "在系统中安装客户端需要管理员权限.");
            ...
            this.tooltip.SetToolTip(this.rbProgramFiles, "在 Program Files 中安装客户端需要管理员权限.");
            ...
            this.removeHostToolStripMenuItem.Text = "移除主机";
            ...
            this.clearToolStripMenuItem.Text = "全部清除";
            ...
            //this.label3.Text = "激活无人值守模式允许远程控制客户端\r\n without user " +"interaction.";
            this.label3.Text = "激活无人值守模式允许远程控制客户端\r\n";
            // 
            // chkUnattendedMode
            // 
            ...
            this.label9.Text = "唯一的互斥锁确保只有一个客户端实例在运行\r\n";
            // 
            // line6
            // 
            ...
            this.label7.Text = "您可以选择一个标签来识别您的客户.";
            // 
            // lblTag
            // 
            ...
            this.chkChangeIcon.Text = "更改程序集 Icon";
